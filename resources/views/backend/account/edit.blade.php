                ...
                <div class="col-12 col-sm-12">
                    <div class="card card-primary card-tabs">
                        ...
                        <form id="form" method="POST"
                            action="{{ route('backend.accounts.accounts.update', $account->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                    ...
                                    <div class="tab-pane fade show active" id="custom-tabs-three-info" role="tabpanel"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" value="1" name="keepPassword"
                                                    type="checkbox" id="keepPassword" checked>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label for="customCheckbox1" class="custom-control-label">Hoạt
                                                    động</label>
                                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <input class="" value="{{ $role->id }}" name="role_id[]"
                                                                ...
                                                                {{ $account->getRoles()->where('role_id', '=', $role->id)->first() != null &&
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <th class="text-center align-middle" colspan="2"><small><span
                                                                style="color:#ff0000">*</span> Nếu không tick thì mặc
                                                            định
