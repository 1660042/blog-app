                ...
                <form id="form" method="POST" action="{{ route('backend.posts.posts.store') }}">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name" onkeyup="getSlug()" onchange="getSlug()" placeholder="Nhập tên bài viết">
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input id="path_image" onchange="previewImage()" class="form-control" value="" placeholder="Đường dẫn hình ảnh" type="text" name="path_image">
