                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" value="{{ $post->name }}"
                                        name="name" onkeyup="getSlug()" onchange="getSlug()"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="path_image" onchange="previewImage()" class="form-control"
                                            value="{{ $post->path_image }}" readonly placeholder="Đường dẫn hình ảnh"
                                            type="text" name="path_image">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="my-editor" rows="3"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" value="1"
                                            {{ $post->status == '1' ? 'checked' : '' }} name="status" type="checkbox"
